...
Deno.test("it should return the element with the minimum value using the default comparer", () => {
  // arrange
...
Deno.test("it should return the first occurrence of the minimum value when duplicates exist", () => {
  // arrange
...
Deno.test("it should work with objects using a valueSelector", () => {
  // arrange
  interface Item {
    weight: number;
    name: string;
...
Deno.test("it should work correctly with a custom comparer", () => {
  // arrange
  const data = Enumerable.from<string>([
    "sunflower",
    "rose",
    "tulip",
    "daisy",
