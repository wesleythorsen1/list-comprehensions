...
describe('toRecord', () => {
  it('should return an empty record when the source is empty (tuple overload)', () => {
    // arrange
  ...
  it('should convert a sequence of tuples into a record (tuple overload)', () => {
    // arrange
  ...
  it('should create a record using keySelector only', () => {
    // arrange
    interface Item {
      id: string;
      value: number;
  ...
  it('should create a record using keySelector and valueSelector', () => {
    // arrange
    interface Item {
      id: string;
      value: number;
  ...
  it('should overwrite duplicate keys, taking the last element encountered', () => {
    // arrange
    interface Item {
      id: string;
      value: number;
